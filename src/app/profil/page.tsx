  ...
  const avatar = (
      <div className="mt-6 flex flex-col items-center md:mt-0 md:items-start md:pt-2">
        <div className="relative">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-nest-solid text-2xl font-bold text-white shadow-md md:h-24 md:w-24 md:text-3xl">
            {USER.initials}
          </div>
        ...
        <span className="mt-1.5 inline-flex items-center gap-1 rounded-full bg-nest-solid px-2.5 py-1 text-[11px] font-medium text-white">
          <IconCrown /> {USER.tier}
        </span>
      </div>
  );
  ...
  return (
    <div className="px-5 pb-6 md:px-0 md:pb-0">
      ...
      <div className="md:desk-grid-profile">
        ...
        <div className="flex w-full items-center gap-3 border-t border-border px-4 py-3.5">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-sage-muted text-nest">
            <IconBell size={18} />
          </span>
        ...
        {(
          ...
          return (
            <button
              ...
              type="button"
              onClick={() => setSheet(row.id)}
              className="flex w-full items-center gap-3 border-t border-border px-4 py-3.5 text-left transition-colors active:bg-sage-muted/40"
            >
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-sage-muted text-nest">
                <Icon size={18} />
              </span>
        ...
        <button
          ...
          className="flex w-full items-center gap-3 border-t border-border px-4 py-3.5 text-left active:bg-danger-soft/60"
        >
